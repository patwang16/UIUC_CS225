...
TEST_CASE("List::reverse simple #1", "[weight=2][part=2][valgrind]") {
    List<int> list;
...
TEST_CASE("List::reverseNth simple #1", "[weight=2][part=2][valgrind]") {
    List<int> list;
...
TEST_CASE("List::merge simple #1", "[weight=2][part=2][valgrind]") {
